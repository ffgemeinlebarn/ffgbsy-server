...
{
    public partial class ffgbsyContext : DbContext
    {
        public ffgbsyContext()
        {
        }

        public ffgbsyContext(DbContextOptions<ffgbsyContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySql("server=localhost;user=root;database=ffgbsy", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.4.21-mariadb"));
            }
        }
